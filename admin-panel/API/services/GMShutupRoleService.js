...
class GMShutupRole {
    async muteRole(roleid, time, reason) {
        return new Promise((resolve, reject) => {
            ...
            client.once('data', (initialResponse) => {
                try {
                    ...
                    packet.pack(config.type.muteRole);
                    ...
                    client.once('data', (response) => {
                        try {
                            ...
                            if (retcode === 0) {
                                ...
                                resolve({ success: true, message: `Mute aplicado com sucesso para a role ${dstroleid} tempo: ${forbid_time}.` });
                            } else {
